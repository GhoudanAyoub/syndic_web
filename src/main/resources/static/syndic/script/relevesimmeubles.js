$(document).ready(function() {
    ...
    function remplirDates(data) {
        ...
        {
            $.ajax({
                url : '/api/immeubles/revenus/' + $("#immeuble").val() + '/' + this.value,
                type : 'GET',
                async : false,
                success : function(data,
                                   textStatus, jqXHR) {
    ...
    function remplirDepenses(data) {
        ...
        if (Object.keys(data).length > 0) {
            ...
            ligne = '<td colspan="13" align="center"><p class="fs-2">Pas de dépenses !<p></td></tr>';
        }
        $("#table-depense").html(ligne);
    }
});
