...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './payement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYEMENT actions', async () => {
      const expectedActions = [
        {
