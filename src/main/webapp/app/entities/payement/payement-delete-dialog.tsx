...
import { getEntity, deleteEntity } from './payement.reducer';

export const PayementDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(payementEntity.id));
  };
...
export default PayementDeleteDialog;
