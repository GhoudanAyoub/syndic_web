...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './immeuble.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMMEUBLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMMEUBLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMMEUBLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMMEUBLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMMEUBLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMMEUBLE actions', async () => {
      const expectedActions = [
        {
