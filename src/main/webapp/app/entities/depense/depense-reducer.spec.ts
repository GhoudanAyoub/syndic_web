...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './depense.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPENSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEPENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPENSE actions', async () => {
      const expectedActions = [
        {
