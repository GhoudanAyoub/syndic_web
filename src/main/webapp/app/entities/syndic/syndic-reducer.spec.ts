...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './syndic.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYNDIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_SYNDIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SYNDIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SYNDIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SYNDIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SYNDIC actions', async () => {
      const expectedActions = [
        {
