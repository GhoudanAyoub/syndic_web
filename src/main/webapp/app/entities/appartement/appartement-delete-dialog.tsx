...
export const AppartementDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="syndicWebApp.appartement.delete.question">
        <Translate contentKey="syndicWebApp.appartement.delete.question" interpolate={{ id: appartementEntity.id }}>
