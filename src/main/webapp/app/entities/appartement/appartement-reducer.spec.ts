...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPARTEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPARTEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPARTEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPARTEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPARTEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPARTEMENT actions', async () => {
      const expectedActions = [
        {
