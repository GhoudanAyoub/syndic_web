...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './resident.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESIDENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESIDENT actions', async () => {
      const expectedActions = [
        {
