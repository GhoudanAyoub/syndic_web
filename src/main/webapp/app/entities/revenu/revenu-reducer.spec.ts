...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './revenu.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVENU_LIST actions', async () => {
    ...
    it('dispatches FETCH_REVENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REVENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REVENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REVENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REVENU actions', async () => {
      const expectedActions = [
        {
