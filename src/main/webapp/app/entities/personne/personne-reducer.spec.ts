...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './personne.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONNE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONNE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONNE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONNE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONNE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONNE actions', async () => {
      const expectedActions = [
        {
